...
// //true olması için ikisinin de true olması lazım
// console.log(x<10 || y>11)
...
//name ?? name2
//il değer undefined/null değilse ilk değer yoksa ikinci değeri yazar
...
// && and operator (|| nın tam tersi olarak çalışır)
//(solda bir değer görürse sağdakini çalıştırır.)
// console.log(name && text)
// console.log(name2 && text)
// console.log(name3 && text)
// console.log(name4 && text)
